...
;;; inet6-related constants added by Jeffrey T. Read.
...
(define address-family/internet6 24)    ; IPv6
;;; NOTE: address-family/internet6 and protocol-family/internet6 are 28 on
;;; FreeBSD, not 24. The gamsock configure script will automatically create
;;; provisions to reassign these two variables to the proper value on FreeBSD.
...
(define protocol-family/internet6 24)   ; IPv6
;;; NOTE: address-family/internet6 and protocol-family/internet6 are 28 on
;;; FreeBSD, not 24. The gamsock configure script will automatically create
;;; provisions to reassign these two variables to the proper value on FreeBSD.
